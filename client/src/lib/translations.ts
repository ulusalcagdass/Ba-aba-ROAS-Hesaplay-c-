...
export const translations = {
    tr: {
        ...
        save: "Kaydet",
        history: "Geçmiş",
        successShared: "Hesaplama Paylaşıldı",
        successSharedDesc: "Link panoya kopyalandı",
        errorShare: "Hesaplama paylaşılamadı",
        successLoadedUrl: "Hesaplama URL'den yüklendi",
        salesPrice: "Satış Fiyatı",
        netProfit: "Net Kâr",
        margin: "Marj",
        successExport: "Dışa Aktarma Başarılı",
        successExportDesc: "Dosyanız indirildi",
        export: "Dışa Aktar",
        share: "Paylaş",
    ...
    en: {
        ...
        save: "Save",
        history: "History",
        successShared: "Calculation Shared",
        successSharedDesc: "Link copied to clipboard",
        errorShare: "Failed to share calculation",
        successLoadedUrl: "Calculation loaded from URL",
        salesPrice: "Sales Price",
        netProfit: "Net Profit",
        margin: "Margin",
        successExport: "Export Successful",
        successExportDesc: "Your file has been downloaded",
        export: "Export",
        share: "Share",
