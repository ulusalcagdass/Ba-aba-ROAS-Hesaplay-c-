...
export const translations = {
    tr: {
        ...
        successShared: "Link Kopyalandı",
        successSharedDesc: "Hesaplama linki panoya kopyalandı.",
        errorShare: "Paylaşım Hatası",
        successLoadedUrl: "Paylaşılan hesaplama yüklendi",
        successExport: "Excel İndirildi",
        successExportDesc: "Hesaplamalar Excel dosyası olarak indirildi.",
        share: "Paylaş",
        export: "Dışa Aktar",
    ...
    en: {
        ...
        successShared: "Link Copied",
        successSharedDesc: "Calculation link copied to clipboard.",
        errorShare: "Share Error",
        successLoadedUrl: "Shared calculation loaded",
        successExport: "Excel Downloaded",
        successExportDesc: "Calculations downloaded as Excel file.",
        share: "Share",
        export: "Export",
